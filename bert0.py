...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--get-reps", action="store_true", default=False, help="Get out document representations."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--do-train", action="store_true", default=False, help="Whether to run training."
    )
    parser.add_argument(
        "--do-eval", action="store_true", default=False, help="Whether to run eval on the dev set."
    )
